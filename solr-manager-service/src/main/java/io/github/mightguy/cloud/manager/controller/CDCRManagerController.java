...
@RequestMapping({"${microservice.contextPath}" + "/cdcr"})
public class CDCRManagerController {
  ...
  public Response enableBufferOnCDCRUpdates(
      @PathVariable("collectionName") String collectionName,
      @PathVariable("cluster") String cluster) {
    return cdcrManagerService.enableBuffer(cluster, collectionName, true);
  }
  ...
  public Response disableBufferOnCDCRUpdates(
      @PathVariable("collectionName") String collectionName,
      @PathVariable("cluster") String cluster) {
    return cdcrManagerService.enableBuffer(cluster, collectionName, false);
  }
  ...
  public Response getCurrentState(
      @PathVariable("collectionName") String collectionName,
      @PathVariable("cluster") String cluster) {
    return cdcrManagerService.status(cluster, collectionName);
  }
  ...
  public Response monitorCDCRErrors(
      @PathVariable("collectionName") String collectionName,
      @PathVariable("cluster") String cluster) {
    return cdcrManagerService.errors(cluster, collectionName);
  }
  ...
  public Response monitorCDCRQueueStats(
      @PathVariable("collectionName") String collectionName,
      @PathVariable("cluster") String cluster) {
    return cdcrManagerService.statsQueue(cluster, collectionName);
  }
  ...
  public Response monitorCDCRReplicationLogs(
      @PathVariable("collectionName") String collectionName,
      @PathVariable("cluster") String cluster) {
    return cdcrManagerService.statsReplication(cluster, collectionName);
  }
