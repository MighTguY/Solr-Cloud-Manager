...
/**
 * This class {@code ExceptionAdviceHandler} is responsible for handling all the exceptions,
 * <ul>
 *   <li>1.System Exceptions inheriting {@code Exception} <li/>
 *   <li>2. Application Exceptions inheriting  {@code SolrCommonsException}<li/>
 * </ul>
 */
@ControllerAdvice
@RestController
...
public class ExceptionAdviceHandler {
  ...
  public final Response handleConstraintException(ConstraintViolationException ex,
    ...
    return new Response(HttpStatus.BAD_REQUEST, "Constraint Violations", errors);
  }
}
