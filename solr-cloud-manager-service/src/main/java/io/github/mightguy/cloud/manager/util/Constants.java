...
public final class Constants {
  ...
  public static final String UPLOAD_CONFIG_TO_ZOOKEEPER = "upload_config_to_zk";
  public static final String DELETE_OLD_COLLECTIONS = "delete_old_collections";
  public static final String DELETE_OLD_COLLECTION = "delete_old_collection";
  public static final String COLLECTION_NAMES = "collections";
  ...
  public static final String SOLR_CONFIG_FILE = "solr_configuration_file";
  public static final String ALL_ALIASES_DELETED = "All Aliases Deleted";
  public static final String COLLECTION_ALIAS_DELETED = "Collection Alias Deleted";
  ...
  public static final String CLUSTER_RELOADED = "Cluster Reloaded ";
